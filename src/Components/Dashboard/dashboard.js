                            ...
                            <div class="scroll dashboard-list-with-thumbs">
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        <img src={require('../../assets/img/products/marble-cake-thumb.jpg')} alt="Marble Cake"
                                ...
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        <img src={require('../../assets/img/products/fruitcake-thumb.jpg')} alt="Fruitcake"
                                            class="list-thumbnail border-0" />
                                        <span
                                            class="badge badge-pill badge-theme-2 position-absolute badge-top-right">NEW</span>
                                    </a>
                                ...
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        <img src={require('../../assets/img/products/chocolate-cake-thumb.jpg')} alt="Chocolate Cake"
                                            class="list-thumbnail border-0" />
                                        <span
                                ...
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        <img src={require('../../assets/img/products/fat-rascal-thumb.jpg')} alt="Fat Rascal"
                                            class="list-thumbnail border-0" />
                                        <span
                                ...
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        <img src={require('../../assets/img/products/streuselkuchen-thumb.jpg')} alt="Streuselkuchen"
                                            class="list-thumbnail border-0" />
                                        <span
                                            class="badge badge-pill badge-theme-3 position-absolute badge-top-right">DONE</span>
                                    </a>
                                ...
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        <img src={require('../../assets/img/products/cremeschnitte-thumb.jpg')} alt="Cremeschnitte"
                                            class="list-thumbnail border-0" />
                                        <span
                                            class="badge badge-pill badge-theme-3 position-absolute badge-top-right">DONE</span>
                                    </a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="scroll dashboard-list-with-user">
                                <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    <a href="#">
                                        <img src={require('../../assets/img/profiles/l-1.jpg')} alt="Mayra Sibley"
                                ...
                                <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    <a href="#">
                                        <img src={require('../../assets/img/profiles/l-7.jpg')} alt="Mimi Carreira"
                                            class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                    </a>
                                    <div class="pl-3">
                                        <a href="#">
                                ...
                                <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    <a href="#">
                                        <img src={require('../../assets/img/profiles/l-6.jpg')} alt="Philip Nelms"
                                            class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                    </a>
                                    <div class="pl-3">
                                        <a href="#">
                                ...
                                <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    <a href="#">
                                        <img src={require('../../assets/img/profiles/l-3.jpg')} alt="Terese Threadgill"
                                            class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                    </a>
                                    <div class="pl-3">
                                        <a href="#">
                                ...
                                <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    <a href="#">
                                        <img src={require('../../assets/img/profiles/l-5.jpg')} alt="Kathryn Mengel"
                                            class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                    </a>
                                    <div class="pl-3">
                                        <a href="#">
                                ...
                                <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    <a href="#">
                                        <img src={require('../../assets/img/profiles/l-4.jpg')} alt="Esperanza Lodge"
                                            class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                    </a>
                                    <div class="pl-3">
                                        <a href="#">
                                ...
                                <div class="glide__track" data-glide-el="track">
                                    <div class="glide__slides">
                                        <div class="glide__slide">
                                            <img src={require('../../assets/img/carousels/1.jpg')} alt="Cheesecake" class="mb-4" />
                                        ...
                                        <div class="glide__slide">
                                            <img src={require('../../assets/img/carousels/2.jpg')} alt="Chocolate Cake" class="mb-4" />
                                        ...
                                        <div class="glide__slide">
												src={require('../../assets/img/carousels/3.jpg')} alt="Cremeschnitte" class="mb-4" />
