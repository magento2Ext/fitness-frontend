                  ...
                  {items.map((item, i) => {
                      return (
                         <tr key={item._id}>
						  ...
						  <td>{item.zipCode}</td>
						  <td>{item.modules}</td>
						  <td><span style={{background: item.primaryColor,borderRadius:'5px',height:'25px',width: '60px',float: 'left'}}></span></td>
						  <td><span style={{background: item.secondaryColor,borderRadius:'5px',height:'25px',width: '60px',float: 'left'}}></span></td>
						  <td><span style={{background: item.textColor,borderRadius:'5px',height:'25px',width: '60px',float: 'left'}}></span></td>
						  <td>
