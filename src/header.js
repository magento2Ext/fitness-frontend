        ...
        <div class="navbar-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right mt-3 position-absolute" id="notificationDropdown">
                        <div class="scroll">
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src={require('./assets/img/profiles/l-2.jpg')} alt="Notification Image"
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src={require('./assets/img/notifications/1.jpg')} alt="Notification Image"
                                        class="img-thumbnail list-thumbnail xsmall border-0 rounded-circle" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src={require('./assets/img/notifications/2.jpg')} alt="Notification Image"
                                        class="img-thumbnail list-thumbnail xsmall border-0 rounded-circle" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 ">
                                <a href="#">
                                    <img src={require('./assets/img/notifications/3.jpg')} alt="Notification Image"
                                        class="img-thumbnail list-thumbnail xsmall border-0 rounded-circle" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
            ...
            <div class="user d-inline-block">
                <button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    <span>
                        <img alt="Profile Picture" src={require('./assets/img/profiles/l-1.jpg')} />
                    </span>
                </button>
